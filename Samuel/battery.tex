...
\caption{Battery cell stack (simplified 6s configuration; actual design is 6s3p) I DREW BUT BASED ON CALTECH PAPER}
\label{fig:bcs}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.388\textwidth} % Use [b] to align captions at the bottom
        ...
        \label{fig:reccrop}
    \end{subfigure}
    \caption{Comparison of cell equalisation strategies ADAPTED SIMULINK MODEL}
    \label{fig:rescvrec}
\end{figure}
